...
namespace CEG_RazorWebApp.Pages.Teacher.Course
{
    public class SessionInfoModel : PageModel
    {
            ...
            [FromRoute][Required] int sessionId)
        {
            ...
            CourseId = courseId;
            TeacherAPI_URL += "Session/" + sessionId;
            string? accToken = HttpContext.Session.GetString(Constants.ACC_TOKEN);

            var sessionInfoResponse = await methcall.CallMethodReturnObject<TeacherSessionInfoResponseVM>(
        ...
        //        return Redirect("/Teacher/Course/" + CourseId + "/Session/"+ sessionId +"/Info");
        //    }
        ...
        //{
        //    TeacherAPI_URL += "Homework/" + homeworkId + "/Update";
        //    string? accToken = HttpContext.Session.GetString(Constants.ACC_TOKEN);
        //    if (!ModelState.IsValid)
        //    {
        ...
        //        return Redirect("/Teacher/Course/" + CourseId + "/Session/" + sessionId + "/Info");
        //    }
        //    var courseInfoResponse = await methcall.CallMethodReturnObject<TeacherHomeworkUpdateResponseVM>(
        //        _httpClient: _httpClient,
        //        options: jsonOptions,
        //        methodName: Constants.PUT_METHOD,
        //        url: TeacherAPI_URL,
