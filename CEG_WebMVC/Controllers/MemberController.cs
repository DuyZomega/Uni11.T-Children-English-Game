...
namespace CEG_WebMVC.Controllers
{
    ...
    public class MemberController : Controller
    {
        ...
        public async Task<IActionResult> MemberBird()
        {
            ...
            birdModel.CreateBird = methcall.GetValidationTempData<BirdViewModel>(this, TempData, Constants.CREATE_BIRD_VALID, "createBird", options);
        ...
        public async Task<IActionResult> MemberBirdDetail([FromRoute][Required] int birdId)
        {
            ...
            memberBirdVM.UpdateBird = methcall.GetValidationTempData<BirdViewModel>(this, TempData, Constants.UPDATE_BIRD_VALID, "updateBird", options);
        ...
        public async Task<IActionResult> MemberCreateBird(BirdViewModel createBird)
        {
            ...
            {
                TempData = methcall.SetValidationTempData(TempData, Constants.CREATE_BIRD_VALID, createBird, options);
